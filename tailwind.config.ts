    ...
    extend: {
      ...
      keyframes: {
        ...
        "travel-contact-bottom": {
          "0%": { left: "40px", opacity: "0", transform: "scale(0.8)" },
          "5%": { opacity: "1", transform: "scale(1)" },
          "20%": { left: "40px" },
          "25%": { left: "calc(33.33% - 40px)" },
          "45%": { left: "calc(33.33% - 40px)" },
          "50%": { left: "calc(66.66% - 40px)" },
          "70%": { left: "calc(66.66% - 40px)" },
          "75%": { left: "calc(100% - 120px)" },
          "90%": { left: "calc(100% - 120px)", opacity: "1", transform: "scale(1)" },
