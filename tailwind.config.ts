  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "travel-contact": {
          "0%": { left: "60px", opacity: "0", transform: "translateY(-50%) scale(0.8)" },
          "5%": { opacity: "1", transform: "translateY(-50%) scale(1)" },
          "20%": { left: "60px" },
          "25%": { left: "calc(33.33% - 10px)" },
          "45%": { left: "calc(33.33% - 10px)" },
          "50%": { left: "calc(66.66% - 10px)" },
          "70%": { left: "calc(66.66% - 10px)" },
          "75%": { left: "calc(100% - 70px)" },
          "90%": { left: "calc(100% - 70px)", opacity: "1", transform: "translateY(-50%) scale(1)" },
          "95%": { opacity: "0", transform: "translateY(-50%) scale(0.8)" },
          "100%": { left: "calc(100% - 70px)", opacity: "0" },
        },
        "travel-contact-vertical": {
          ...
          "70%": { top: "calc(50% + 20px)" },
          "75%": { top: "calc(75% + 20px)" },
          "90%": { top: "calc(75% + 20px)", opacity: "1", transform: "translateX(-50%) scale(1)" },
          "95%": { opacity: "0", transform: "translateX(-50%) scale(0.8)" },
          "100%": { top: "calc(75% + 20px)", opacity: "0" },
        },
        "gradient-shift": {
      ...
      animation: {
        ...
        "travel-contact": "travel-contact 6s ease-in-out infinite",
        "travel-contact-vertical": "travel-contact-vertical 6s ease-in-out infinite",
      },
    },
  },
