  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "travel-contact-bottom": {
          "0%": { left: "0%", opacity: "0", transform: "translateX(-50%) scale(0.8)" },
          "5%": { left: "12.5%", opacity: "1", transform: "translateX(-50%) scale(1)" },
          "20%": { left: "12.5%" },
          "25%": { left: "37.5%", transform: "translateX(-50%) scale(1)" },
          "45%": { left: "37.5%" },
          "50%": { left: "62.5%", transform: "translateX(-50%) scale(1)" },
          "70%": { left: "62.5%" },
          "75%": { left: "87.5%", transform: "translateX(-50%) scale(1)" },
          "90%": { left: "87.5%", opacity: "1", transform: "translateX(-50%) scale(1)" },
          "95%": { opacity: "0", transform: "translateX(-50%) scale(0.8)" },
          "100%": { left: "87.5%", opacity: "0" },
        },
        "travel-contact-vertical-side": {
          "0%": { top: "30px", opacity: "0", transform: "scale(0.8)" },
          ...
          "70%": { top: "calc(50% + 10px)" },
          "75%": { top: "calc(75% + 10px)" },
          "90%": { top: "calc(75% + 10px)", opacity: "1", transform: "scale(1)" },
          "95%": { opacity: "0", transform: "scale(0.8)" },
          "100%": { top: "calc(75% + 10px)", opacity: "0" },
        },
        "gradient-shift": {
      ...
      animation: {
        ...
        "travel-contact-bottom": "travel-contact-bottom 6s ease-in-out infinite",
        "travel-contact-vertical-side": "travel-contact-vertical-side 6s ease-in-out infinite",
      },
    },
  },
