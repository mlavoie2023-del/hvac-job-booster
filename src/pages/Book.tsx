      ...
      <main className="section-container py-12 lg:py-20">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-foreground sm:text-4xl">Book a Discovery Call</h1>
            <p className="mt-4 text-lg text-body">Let's discuss your salon and see how we can help.</p>
          </div>
