      ...
      <div className="section-container">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="text-center px-2">
            <div className="mb-4 sm:mb-6 inline-flex items-center justify-center rounded-xl sm:rounded-2xl bg-primary/10 p-3 sm:p-4">
            ...
            <p className="mx-auto mt-4 sm:mt-6 max-w-2xl text-base sm:text-lg text-muted-foreground lg:text-xl">
              We install an AI-powered software system designed specifically for HVAC companies — so you never miss another opportunity.
            </p>
          </div>

          {/* Benefits Grid */}
          <div className="mt-8 sm:mt-12 grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="flex items-center gap-3 rounded-xl border border-primary/20 bg-primary/5 p-3 sm:p-4 transition-all hover:border-primary/40 hover:bg-primary/10"
              >
                <div className="flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-lg bg-primary/20">
