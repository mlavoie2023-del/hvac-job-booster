    ...
    <section className="relative overflow-hidden bg-primary py-12 sm:py-16 lg:py-28">
      ...
      <div className="section-container relative z-10">
        <div className="mx-auto max-w-3xl text-center px-2">
          ...
          <p className="mx-auto mt-4 sm:mt-6 max-w-xl text-base sm:text-lg text-primary-foreground/80 lg:text-xl">
          ...
          {/* Trust Indicators */}
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4 sm:gap-6 text-primary-foreground/70">
